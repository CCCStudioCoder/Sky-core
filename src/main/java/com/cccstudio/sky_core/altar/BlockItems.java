...
public class BlockItems {
    ...
    /**
     * The altar is the block used to offer items to gods.
     */
    ...
    /**
     * The altar, all the god invokers and the mythical creatures are in this tab.
     */
    public static final Supplier<CreativeModeTab> GODS_CREATIVE_TAB = Core.CREATIVE_TAB_REGISTER.register(
            "gods", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> output.accept(ALTAR_ITEM))
                    .build()
    );
